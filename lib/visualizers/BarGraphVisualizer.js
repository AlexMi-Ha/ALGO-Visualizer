...
class BarGraphVisualizer extends Visualizer {
    ...
    constructor(container, array, hideBarsOnStartup = [], showReset = false) {
        super();
        this.reset(container, array, hideBarsOnStartup, showReset);
    }
    ...
    reset(container, array, hideBarsOnStartup, showReset) {
        container.innerHTML = '';
        ...
        super.addControls(container, showReset, () => this.reset(container, array, hideBarsOnStartup, showReset));
    }
    ...
    initArray(container, array) {
        ...
        for(let i = 0; i < array.length; ++i) {
            $(graph).append(createIndexElement(i));
        }
